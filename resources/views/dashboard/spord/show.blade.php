        ...
        <div class="tab-content d-flex justify-content-center">
            ...
            <div id="dataSPORD" class="pt-3 pb-2 mt-3 mb-5">
                <table border=0 cellpadding=0 cellspacing=0 width=732 style='border-collapse:
                    ...
                    border-bottom:.5pt solid black; vertical-align: top;'>DINAS / UNIT : {{ $spord->kelola->judul }}</td>
                    ...
                    <td class=xl101 style="border-bottom:.5pt solid black; border-right:0.5pt solid black">: {{ $spord->created_at->isoFormat('Y') }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    ...
                    height:19.5pt'>Kepala {{ $spord->kelola->judul }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td colspan=2 height=26 class=xl65 style='border-right:.5pt solid black;
                    height:19.5pt'>Di</td>
                    ...
                    <td colspan=3 class=xl65 style='border-right:.5pt solid black'>: {{ $spord->nama }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl90 colspan=2 style='height:19.5pt;mso-ignore:colspan; border-left:0.5pt solid black'><span
                    style='mso-spacerun:yes'>       </span>&nbsp;&nbsp;&nbsp;2. Nama Badan / Perusahaan</td>
                    <td colspan=3 class=xl65 style='border-right:.5pt solid black'>: {{ $spord->organisasi }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl90 colspan=2 style='height:19.5pt;mso-ignore:colspan; border-left:0.5pt solid black'><span
                    style='mso-spacerun:yes'>       </span>&nbsp;&nbsp;&nbsp;3. Alamat Perusahaan</td>
                    <td colspan=3 class=xl65 style='border-right:.5pt solid black'>: {{ $spord->alamat }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl90 colspan=2 style='height:19.5pt;mso-ignore:colspan; border-left:0.5pt solid black'><span
                    style='mso-spacerun:yes'>       </span>&nbsp;&nbsp;&nbsp;4. Lokasi Kegiatan</td>
                    <td colspan=3 class=xl65 style='border-right:.5pt solid black'>: {{ $spord->lokasi }}</td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    ...
                    style='mso-spacerun:yes'>    </span>&nbsp;&nbsp;&nbsp;1. {{ $spord->objek1 }}<span
                    style='mso-spacerun:yes'>  </span></td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl74 style='height:19.5pt; border-left:0.5pt solid black'>&nbsp;</td>
                    <td colspan=4 class=xl65 style='border-right:.5pt solid black'><span
                    style='mso-spacerun:yes'>    </span>&nbsp;&nbsp;&nbsp;2. {{ $spord->objek2 }}<span
                    style='mso-spacerun:yes'>  </span></td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl74 style='height:19.5pt; border-left:0.5pt solid black'>&nbsp;</td>
                    <td colspan=4 class=xl65 style='border-right:.5pt solid black'><span
                    style='mso-spacerun:yes'>    </span>&nbsp;&nbsp;&nbsp;3. {{ $spord->objek3 }}<span
                    style='mso-spacerun:yes'>  </span></td>
                    </tr>
                    <tr height=26 style='mso-height-source:userset;height:19.5pt'>
                    <td height=26 class=xl74 style='height:19.5pt; border-left:0.5pt solid black'>&nbsp;</td>
                    <td colspan=4 class=xl65 style='border-right:.5pt solid black'><span
                    style='mso-spacerun:yes'>    </span>&nbsp;&nbsp;&nbsp;4. {{ $spord->objek4 }}</td>
                    </tr>
                    <tr height=10 style='mso-height-source:userset;height:7.5pt'>
                    <td height=10 class=xl74 style='height:7.5pt; border-left:0.5pt solid black'>&nbsp;</td>
                    ...
                    </span>Pontianak, {{ $spord->created_at->isoFormat('DD MMMM Y') }}</td>
                    </tr>
                    <tr height=20 style='height:15.0pt'>
                    <td height=20 class=xl66 style='height:15.0pt'></td>
                    <td colspan=2 style='mso-ignore:colspan'></td>
                    ...
                    <td class=xl66></td>
                    <td class=xl66></td>
                    <td colspan=2 class=xl99 style="text-align: center">{{ $spord->nama }}</td>
                    </tr>
